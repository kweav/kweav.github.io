...
I am currently a Post Doc with the Training Group at [the Data Science Lab at Fred Hutchinson Cancer Center](https://hutchdatascience.org/). My background is in functional and evolutionary genomics with experience building simulation and machine learning models. My work supports the [ITCR Training Network](https://www.itcrtraining.org/), the [AnVIL](https://anvilproject.org/) project, and [Open Case Studies](https://www.opencasestudies.org/).
